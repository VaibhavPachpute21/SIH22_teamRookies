    ...
    return (
        <Box w={'100%'} bg="grey" p={5} mt={10} >
            <Flex flexDirection={['column','column','row','row']}>
                <Flex w={["100%","100%",'30%','30%']} bg={'white'} alignitems={'center'} justifyContent={'center'}>
                    <Image src='./image/logo.png' height={'200px'} alignSelf={'center'} />
                </Flex>
                <Flex w={["100%","100%",'40%','40%']} padding={2} flexDirection={'column'} color={'white'}>
                ...
                <Flex w={["100%","100%",'30%','30%']} textAlign={'start'} flexDirection={'column'} px={3} paddingLeft={5} color={'white'} >
