  ...
  const HandleSubmit = async (data) => {
    ...
    try {
      const newGrievance = await axios.post(
        "http://localhost:3001/api/grievance/make-grievance",
        obj
      );
          ...
          toast({
            ...
            render: () => (
              <Box color="white" p={3} bg="green.500">
                Grievance submitted {d.newGrievance.short_id}
              </Box>
            ),
          });
          ...
          <form onSubmit={handleSubmit(HandleSubmit)}>
            <FormControl>
              <Box w={"100%"} bg="white" paddingTop={5}>
                <Text textAlign={"center"} fontSize={["xl", "3xl", "3xl"]}>
              ...
              >
                <Box w={["90%", "90%", "50%", "50%"]}>
                  <Text fontSize={"18px"} paddingLeft={2}>
                    Institute Name:
                  </Text>
                  <Input
                    variant={"filled"}
              ...
              >
                ...
                <Box w={["90%", "90%", "25%", "25%"]}>
                  ...
                  <Input
                    variant={"filled"}
                    value={User?.institute_university}
                    readOnly={true}
                  />
                </Box>
                <Box w={["90%", "90%", "25%", "25%"]}>
              ...
              <Box w={"100%"} bg="white" py={[5]} px={[2, 2, 10, 10]}>
                <Text textAlign={"center"} fontSize={["xl", "3xl", "3xl"]}>
                  Enter Details To submit Grievance
                </Text>
              </Box>
              ...
              >
                <Box w={["90%", "90%", "50%", "50%"]}>
                  <Text fontSize={"18px"} paddingLeft={0}>
                    Principal Name:
                  </Text>
                  <Input
                    variant={"flushed"}
                    value={User?.name_of_director}
                    readOnly={true} // name="pName" id="pName"
                ...
                <Box w={["90%", "90%", "50%", "50%"]}>
                  ...
                  <Select
                    ...
                    name="nature"
                    id="nature"
                    placeholder="Select Nature of Grievance"
                    {...register("nature", {
                      required: {
                        value: true,
                        message: "Please choose Nature of Grievance",
                      },
                    })}
                  >
              ...
              <Box w={"100%"} bg="white" py={[5, 5, 5, 5]} px={[2, 2, 10, 10]}>
                ...
                <Input
                  variant={"flushed"}
                  placeholder="Give title for Grievance"
                  name="title"
                  id="title"
                  {...register("title", {
              ...
              <Box w={"100%"} bg="white" px={[2, 2, 10, 10]}>
                <Text fontSize={"18px"} pb={2} paddingLeft={0}>
                  Discription of Grievance:
                </Text>
                <Textarea
                  variant={"flushed"}
                  id="discription"
                  name="discription"
                  placeholder="Add discription of your Grievance..."
                  wrap="true"
                  cols={95}
                  rows={5}
                  style={{
              ...
              <Box w={"100%"} bg="white" py={3} px={[2, 2, 10, 10]}>
                <Text fontSize={"18px"} pb={2} paddingLeft={0}>
                  Please upload image related to grievance if any:
                </Text>
                <input
                  name="file1"
                  type="file"
