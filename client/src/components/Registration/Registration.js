...
function Registration(props) {
  ...
  const [authenticated, setAuthticate] = useState(false)
  ...
  useEffect(() => {
    const mojoauth = new MojoAuth("test-713888b8-a77f-4948-b6a1-e64219d7ce15", {
      source: [{ type: 'email', feature: 'magiclink' }]
    });
    mojoauth.signIn().then(payload => {
      setPayload(payload)
      setAuthticate(payload?.authenticated)
      console.log(payload)
    ...
    <Box>
      ...
      <Box className='Login-Background' minH={'max-content'} maxWidth={"100vw"} overflow={'hidden'} align="center">
        <Flex height="100%" align={'center'} width={"100%"} flexDirection={'row'}>
          <Box w={["0%", "40%", "40%"]} h="100vh" display={['none', 'block', 'flex']}
          // bg="#5A4FCF"
          ><Flex
                ...
                <VStack w="100%" h="100%" alignItems={'center'} justifyContent={'center'}>
                  ...
                  <Box w="60%">
                    <Text color={'white'} fontWeight={600}>
                      Register your grievance and have it resolved. This registration is reserved for students, professors, and employees of HEIs (Higher Education Institutes). HEIs and grievance redressal bodies can log in directly using their login credentials.
                    </Text>
                  </Box>
                </VStack>
              </Box>
          ...
          <Box w={['100%', '60%', '60%']} bg={'white'}>
            ...
            {authenticated == false ? <div id="mojoauth-passwordless-form"></div> :
                    ...
                    >
                      ...
                      <GridItem>
                        ...
                        <InputGroup size={'md'}>
                          ...
                          value={payload?.user.email} readOnly={true} 
                            {...register("email", {
