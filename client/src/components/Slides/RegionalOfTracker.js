...
export default function RegionalOfTracker() {
                            ...
                            <AccordionButton>
                                <Box flex='1'>
                                    <Flex justifyContent={'space-evenly'}>
                                        <Box>
                                            Grievance Title: <strong>Grievance related to syllabus</strong>
                                        </Box>
                                        <Box>
                                            Raised By: <strong>Universal Collage </strong>
                                        </Box>
                                    </Flex>
                                </Box>
                                <AccordionIcon />
