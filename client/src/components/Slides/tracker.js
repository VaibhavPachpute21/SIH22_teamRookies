...
const DashboardTracker = (props) => {
  ...
  const FakeGrievances = [
    {
      ...
      grievance_title:
        "Grievance _id: 28492309 is pending, please take action.",
  ...
  return (
    <Flex
      py={3}
      w="100%"
      h={["max-content", "max-content", "100%", "100%"]}
      flexDirection={"column"}
    >
      <HStack w="100%" h="5%">
        <Box w="80%" h="100%">
          <HStack borderRadius={"md"} w="100%" h="90%">
            {filterTabs?.map((item, i) => (
              <Box key={i} w="20%" h="100%" borderRadius={"2xl"}>
                <Flex
                  w="100%"
                  h="100%"
                  alignItems={"center"}
      ...
      <Flex w="100%" h="95%" flexDirection={["column", "column", "row", "row"]}>
        {User.role == "0P" ? null : (
          <Box w={["100%", "100%", "30%", "30%"]} h="100%">
            <Flex
              w="100%"
              h={["max-content", "100%", "100%"]}
              flexDirection={"column"}
            >
              <Box w="100%" h="10%">
                <Flex
              ...
              <Box borderTop={"1px"} borderColor={"#5A4FCF"} w="100%" h="40%">
                <Flex
                  w="100%"
                  h={["max-content", "max-content", "100%", "100%"]}
                  flexDirection={"column"}
                >
                  <Box py={3} px={3} w="100%" h="10%">
                    <Text
                      fontSize={"lg"}
                      opacity={0.8}
                      fontFamily={"monospace"}
                  ...
                  <Flex
                    ...
                    py={3}
                    w="100%"
                    h={["max-content", "max-content", "90%", "90%"]}
                  >
                      ...
                      i < 6 ? (
                        <HStack spacing={3} key={i} w="100%" h="10%">
                          <Checkbox
                            value={item}
                            onChange={(e) =>
                              setTabsArray(e.target.value, e.target.checked)
                            }
                            colorScheme="purple"
                            w="5%"
                          />
                    ...
                    >
                      ...
                      <Box w="100%" h="20%">
                        <VStack w="100%" h="100%">
                          ...
                          <Box w="100%" h="80%">
                            <Text w="90%" fontWeight={600} fontSize={"sm"}>
                              {item.reciever_id}
                            </Text>
                          </Box>
                        </VStack>
                  ...
                  >
                    ...
                    >
                      <Box w={["100%", "100%", "70%", "70%"]} h="7%">
                        <HStack w="100%" h="100%">
                          <Box w="40%">
                            <Text fontWeight={600} color={"#5A4FCF"}>
                              Submission Date
                            </Text>
                          </Box>
                          <Box w="40%">
