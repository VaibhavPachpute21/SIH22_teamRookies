                ...
                >
                  <FormControl w="100%" h="100%" py={10}>
                    <SimpleGrid spacing={10} columns={1}>
                      ...
                      <GridItem colSpan={1}>
                        <Button bg="#5A4FCF" w="100%" color={"white"}>
                          Login
                        </Button>
                      </GridItem>
                    </SimpleGrid>
          ...
          <VStack spacing={5} py={2} w="100%" h="max-content">
            ...
            >
              <Box w="100%" h="30%">
                ...
                >
                  <Box w="100%" h="100%">
                    <Heading size="xl"> UNIVERSITY GRANTS COMMISSION </Heading>
                  </Box>
                </HStack>
              </Box>
              <Box w="100%" h="50%">
  ...
  render() {
    ...
    return (
      <div style={{ width: "100%" }}>
        ...
        <p>
          The grievance {grievance_id.value} was sent to Nodal officer at 2:30PM
        </p>
      </div>
    );
  }
